...
const useResponsive = () => {
  // Patched (Monsoon): initialize with the real viewport size instead of 0.
  // Starting at 0 made the first frame render as "mobile" (0 < 768), so dots
  // drew at 1.5x spacing / 0.75x size for a tick and visibly snapped once the
  // mount effect measured the window.
