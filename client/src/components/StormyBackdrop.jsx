...
export default function StormyBackdrop() {
    ...
    useEffect(() => {
        ...
        function drawFrame(timestamp) {
            ...
            // Stormy morning deep base — #1a2530
            ctx.fillStyle = "#141e28";
            ctx.fillRect(0, 0, W, H);

            // Depth gradient with stormy palette
            const bgGrad = ctx.createLinearGradient(0, 0, 0, H);
            bgGrad.addColorStop(0, "rgba(56, 73, 89, 0.35)");    // #384959
            bgGrad.addColorStop(0.3, "rgba(26, 37, 48, 0.25)");   // #1a2530
            bgGrad.addColorStop(0.7, "rgba(33, 47, 59, 0.3)");    // #212f3b
            bgGrad.addColorStop(1, "rgba(20, 30, 40, 0.5)");
            ctx.fillStyle = bgGrad;
            ctx.fillRect(0, 0, W, H);

            // Draw wave layers — stormy blue hue range (205-220)
            waveLayers.forEach((layer) => {
                for (let i = 0; i < layer.count; i++) {
                    ...
                    // Stormy blue hues (206 base — matching #6A89A7)
            ...
            // Light reflections with stormy palette
            for (let i = 0; i < 3; i++) {
                ...
                rg.addColorStop(0, `rgba(136, 189, 223, ${refAlpha})`);      // #88BDDF
                rg.addColorStop(0.5, `rgba(106, 137, 167, ${refAlpha * 0.4})`); // #6A89A7
                rg.addColorStop(1, "rgba(56, 73, 89, 0)");                    // #384959
                ctx.fillStyle = rg;
            ...
            for (let i = 0; i < 12; i++) {
                ...
                sg.addColorStop(0.3, `rgba(189, 221, 252, ${sa})`);   // #BDDDFC
