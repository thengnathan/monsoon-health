...
interface NotePopupProps {
    ...
    onSave: (data: Partial<Note>, id?: string) => Promise<void>;
    onDelete: (id: string) => Promise<void>;
    onClose: () => void;
}

// Exported for use in Layout (global floating note)
export function NotePopup({ note, onSave, onDelete, onClose }: NotePopupProps) {
    ...
    const handleSave = async () => {
        const data: Partial<Note> = { title: title.trim() || 'Untitled', content, color, is_pinned: pinned };
