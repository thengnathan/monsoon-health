...
export default function PatientsPage() {
    ...
    useEffect(() => { loadPatients(); api.getReferralSources().then(setReferralSources).catch(() => { }); }, []);
    ...
    const [form, setForm] = useState({ first_name: '', last_name: '', dob: '', internal_identifier: '', referral_source_id: '', referral_date: '', notes: '' });
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            setShowModal(false);
            setForm({ first_name: '', last_name: '', dob: '', internal_identifier: '', referral_source_id: '', referral_date: '', notes: '' });
    ...
    // Document upload — auto-create patient from PDF
    ...
    const docTypeLabels = { FIBROSCAN: 'FibroScan', LAB_REPORT: 'Lab Report', IMAGING: 'Imaging', REFERRAL: 'Referral', CONSENT: 'Consent', OTHER: 'Other' };
