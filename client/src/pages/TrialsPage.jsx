...
export default function TrialsPage() {
    ...
    const [createForm, setCreateForm] = useState({ name: '', protocol_number: '', specialty: '', description: '' });
    ...
    const handleCreate = async (e) => {
        e.preventDefault();
        try {
            const trial = await api.createTrial(createForm);
            addToast('Trial created', 'success');
            setShowCreateModal(false);
            setCreateForm({ name: '', protocol_number: '', specialty: '', description: '' });
